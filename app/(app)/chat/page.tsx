...
export default async function ChatListPage() {
  ...
  return (
    <PremiumPaywallOverlay
      pageName="Conversas Privadas"
      explanation="Fala diretamente com outros colecionadores para negociar e fechar trocas de figurinhas de forma rápida e segura!"
      benefits={[
        "Chats em tempo real com mensagens instantâneas",
        "Negociação direta de figurinhas repetidas e em falta",
        "Notificações push de novas mensagens",
        "Segurança de dados e encriptação básica"
      ]}
    >
