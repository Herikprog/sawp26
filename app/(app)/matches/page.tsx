...
export default function MatchesPage() {
  ...
  return (
    <PremiumPaywallOverlay
      pageName="Matches Elite IA"
      explanation="Descobre conexões perfeitas calculadas pelo nosso algoritmo inteligente! Encontra quem tem as figurinhas que te faltam e quer as tuas repetidas."
      benefits={[
        "Cruzamento inteligente de figurinhas repetidas e em falta",
        "Algoritmo otimizado com prioridade de matching de 95% de precisão",
        "Visualização de matches ordenados por proximidade",
        "Inicia chats imediatos para propor trocas"
      ]}
    >
