...
import { Mail, Lock, ArrowRight, ShieldCheck, Trophy, Users, Zap } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div 
      ...
      style={{
        background: "radial-gradient(circle at 30% 50%, #0D1A35 0%, #060B18 60%)",
    ...
    >
      ...
      <div style={{
        ...
        <div className="pulse-glow" style={{
          ...
          background: "#8B7BF7", opacity: 0.04,
          borderRadius: "50%", filter: "blur(120px)",
          bottom: "10%", right: "-5%",
          animationDelay: "1.5s",
        }} />
        ...
        >
          ...
          <h2 style={{
            ...
            A plataforma definitiva de <br className="hidden lg:block" />
            <span style={{
              background: "linear-gradient(135deg, #00AEEF, #8B7BF7)",
          ...
          <p style={{ color: "#8E9FBF", fontSize: "clamp(14px, 3.5vw, 16px)", lineHeight: 1.6, marginBottom: "clamp(28px, 6vw, 48px)", maxWidth: 400 }}>
            Match automático, geolocalização, chat em tempo real e comunidade ativa de colecionadores.
          </p>

          {/* Feature pills */}
          <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%", maxWidth: 380 }}>
            {[
              { icon: Zap, text: "Algoritmo de match inteligente", color: "#FFCA28" },
              { icon: Users, text: "Comunidade de colecionadores", color: "#00E09E" },
              { icon: Trophy, text: "Rankings e conquistas", color: "#8B7BF7" },
        ...
        >
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ color: "var(--text-sec)", fontSize: 15 }}>
              Entra na tua conta e continua a colecionar.
            </p>
          </div>
          ...
          <div style={{
            ...
            <form onSubmit={handleLogin}>
              <div style={{ marginBottom: 18 }}>
                <label style={{ display: "block", marginBottom: 8, marginLeft: 2, fontSize: 11, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--text-muted)" }}>
                  Email
                </label>
                <div style={{ position: "relative" }}>
                  ...
                  <input type="email" placeholder="nome@exemplo.com" value={email}
                    ...
                    style={{
                      ...
                      borderRadius: 14, padding: "16px 20px 16px 44px",
              ...
              <button type="submit" disabled={loading} style={{
                ...
                gap: 10, background: "var(--gradient-primary)", color: "#fff",
                fontWeight: 700, fontSize: 15, padding: "16px 24px", borderRadius: 14,
                border: "none", cursor: "pointer",
                boxShadow: "0 8px 24px -4px rgba(0,153,255,0.3)",
                transition: "all 0.3s ease",
              }}>
                {loading ? "A entrar..." : "Aceder à Plataforma"}
                <ArrowRight size={16} />
              </button>
            </form>
          </div>
          ...
          <div style={{ marginTop: 32, textAlign: "center" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 11, color: "var(--text-muted)" }}>Encriptação de nível bancário</span>
            </div>
